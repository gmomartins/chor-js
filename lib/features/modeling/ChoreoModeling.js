...
ChoreoModeling.prototype.createSpace = function(movingShapes, resizingShapes, delta, direction, start) {
  ...
  // Thus we have to prevent the SpaceTool from resizing participants or moving them vertically or resizing them.
  // if (direction === 'n' || direction === 's') {
  //   movingShapes = movingShapes.filter(s => !is(s, 'bpmn:Participant') && !is(s, 'bpmn:Message'));
  // }
