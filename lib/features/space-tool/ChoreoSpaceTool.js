 ...
 * it needs to be changed as it gets confused with the participant bands and messages. As they are scaled when the activity is scaled, which is obviously not
 * taken into account by the original bpmn-js slolution.
 *
