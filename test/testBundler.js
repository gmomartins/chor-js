...
const base_options = {
  hmr: true, // Disable hot module reload. it is not needed here.
  outDir: './testDist', // The out directory to put the build files in, defaults to dist
